		...
		<div class="col-md-8">
			...
			<form action="{{ route('admin/colors/update', [$color]) }}" method="POST">
				...
				<div class="form-group">
				    ...
				    <input type="text" class="form-control form-control @error('nombre_color') is-invalid @enderror" id="nombre_color" name="nombre_color" value="{{ $color->nombre_color }}" required>
